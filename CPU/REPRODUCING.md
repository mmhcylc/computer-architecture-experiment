...
`registry.codeocean.com/published/2d9c9b29-b6ab-42bd-a416-5b2e72de5499:v1`
...
docker run --platform linux/amd64 --rm \
  ...
  registry.codeocean.com/published/2d9c9b29-b6ab-42bd-a416-5b2e72de5499:v1 bash run
```
